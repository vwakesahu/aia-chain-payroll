...
const Features = () => {
  return (
    <div className="grid grid-cols-12 gap-8 p-8 max-w-[1400px] mx-auto px-24">
      {/* Image Section */}
      <div className="col-span-5 bg-black/80 rounded-[35px] p-8 relative overflow-hidden">
      ...
      <div className="col-span-7 flex flex-col h-full">
        <div className="flex-1">
          ...
          <div className="grid grid-cols-12 gap-16 py-4 border-b border-gray-200 items-center">
            ...
            <div className="col-span-6">
              <p className="text-gray-600 leading-relaxed m-0">
                Store stablecoins, hiding amounts from
                public visibility.
              </p>
            </div>
          </div>
          ...
          {/* Feature 3 */}
          <div className="grid grid-cols-12 gap-16 py-4 items-center mb-5">
            <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center border border-gray-200 text-lg font-medium">
              03
            </div>
        ...
        <div className=" grid grid-cols-2 place-items-end gap-16">
          ...
          <div className="bg-[#00C670] rounded-[35px] p-8 flex flex-col">
            <div className="flex flex-col h-full justify-between">
              <div className="flex-1" />
              <div>
                <div className="text-[45px] font-medium leading-none text-white mb-4 pb-24">
                  100%
                </div>
